    ...
    $('[data-toggle="tooltip"]').tooltip(),
      ...
      $(".docs-buttons").on("click", "[data-method]", function () {
        ...
        if (
          ...
          switch (
            ((n = e.cropper(i.method, i.option, i.secondOption)), i.method)
          ) {
            case "scaleX":
            case "scaleY":
          ...
          if ("tron" == this.$.data("skin")) {
            ...
            return (
              ...
              this.o.displayPrevious &&
                ...
                this.g.stroke()),
              this.g.beginPath(),
              (this.g.strokeStyle = t ? this.o.fgColor : this.fgColor),
              this.g.arc(
                this.xy,
                this.xy,
                this.radius - this.lineWidth,
            ...
            $(".antosubmit").on("click", function () {
              ...
              return (
                ...
                t &&
                  r.fullCalendar(
                    "renderEvent",
                    { title: t, start: e, end: n, allDay: o, isRTL: !0 },
                    !0
                  ),
                $("#title").val(""),
      ...
      $("#datatable-buttons").length &&
        $("#datatable-buttons").DataTable({
          ...
          buttons: [
            ...
            { extend: "csv", text: "فایل CSV", className: "btn-sm" },
            { extend: "excel", text: "اکسل", className: "btn-sm" },
            { extend: "pdfHtml5", text: "فایل PDF", className: "btn-sm" },
  ...
  if ("undefined" != typeof echarts) {
      ...
      a.setOption({
        ...
        series: [
          ...
          },
          {
            ...
            markPoint: {
              data: [
                { name: "فروش‌ها", value: 182.2, xAxis: 7, yAxis: 183 },
                { name: "خرید‌ها", value: 2.3, xAxis: 11, yAxis: 3 },
              ],
            },
            markLine: { data: [{ type: "average", name: "???" }] },
          },
    ...
    if ($("#echart_scatter").length) {
      ...
      r.setOption({
        ...
        toolbox: {
          show: !0,
          feature: { saveAsImage: { show: !0, title: "ذخیره تصویر" } },
        },
        xAxis: [
