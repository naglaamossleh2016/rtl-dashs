...
function init_validator() {
  ...
  validator.message.invalid = "الإدخال غير متوقع";
  validator.message.short = "الإدخال قصير";
  validator.message.long = "الإدخال طويل";
  validator.message.checked = "يجب التحقق";
  validator.message.empty = "يرجى كتابة شيء هنا";
  validator.message.select = "يرجى اختيار خيار";
  validator.message.number_min = "قليل جدًا";
  validator.message.number_max = "كثير جدًا";
  validator.message.url = "رابط غير صالح";
  validator.message.number = "ليس رقمًا";
  validator.message.email = "عنوان البريد الإلكتروني غير صالح";
  validator.message.email_repeat =
    "تكرار البريد الإلكتروني لا يتطابق مع البريد الإلكتروني";
  validator.message.date = "تاريخ غير صالح";
  validator.message.time = "وقت غير صالح";
  validator.message.password_repeat =
    "تكرار كلمة المرور لا يتطابق مع كلمة المرور";
  validator.message.no_match = "لا يتطابق";
  validator.message.complete = "الإدخال غير مكتمل";
...
function init_PNotify() {
  ...
  new PNotify({
    title: "PNotify",
    type: "info",
    text: "مرحبًا بك. حاول الابتعاد عني، يمكنك النقر على كل شيء خلفي لأنني غير محظور.",
    nonblock: {
      nonblock: true,
    },
    addclass: "dark",
